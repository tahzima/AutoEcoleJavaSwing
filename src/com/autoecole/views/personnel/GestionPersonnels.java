...
public class GestionPersonnels extends JPanel {
	...
	private String[] colonnesPersonnel = { "Nom", "Prenom", "Cin",
			"Date Naissance", "Numero Telephone", "Adresse", "Poste",
	...
	public void refresh(List<Personnels> list) {
		...
		DefaultTableModel model = new DefaultTableModel(dataPersonnel,
				colonnesPersonnel);
	...
	public GestionPersonnels() {
		...
		gestionPersonnelsLbl.setFont(new Font("Oswald",
		...
		iconRecherche = new ImageIcon(this.getClass().getResource(
				"/searche.png")).getImage();
		...
		photoRechercheLbl.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				listPersonnel = gestionPersonnelController
		...
		ajouterLbl.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				AjouterPersonnels ajouterPersonnel = new AjouterPersonnels(
						GestionPersonnels.this);
				ajouterPersonnel.setVisible(true);
			}
		});
		iconAjouter = new ImageIcon(this.getClass().getResource("/ajouter.png"))
		...
		modifierLbl.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				ModifierPersonnels modifierPersonnels = new ModifierPersonnels(
						idPersonnel, GestionPersonnels.this);
				modifierPersonnels.setVisible(true);
			}
		});
		iconModifier = new ImageIcon(this.getClass().getResource(
				"/modifier.png")).getImage();
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (rowIndex == -1)
					JOptionPane.showMessageDialog(null,
							"Vous devez selectionner un Personnel!");
				else {
		...
		iconSupprimer = new ImageIcon(this.getClass()
				.getResource("/delete.png")).getImage();
		...
		tablemodelPersonnel = new DefaultTableModel(dataPersonnel,
				colonnesPersonnel);
